...
@section('content')
    ...
    <div class="admin-my-work">
        ...
        enctype="multipart/form-data">
            {{ csrf_field() }}
            <input type="text" name="name" placeholder="Название проекта" class="admin-my-work__text" required>
            <input type="text" name="technology" placeholder="Технологии" class="admin-my-work__text" required>
            ...
            <input class="admin-my-work__attachment" name="photo" type="file" accept="image/jpeg,image/png" required>
            {{--</label>--}}
