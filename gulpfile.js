...
gulp.task('js', function () {
    //noinspection ES6ConvertVarToLetConst
    var bundleStream = browserify(cfg.paths.src.js).bundle();

    bundleStream
        .pipe(source(cfg.paths.src.js))
        .pipe(gulpif(production, streamify(uglify())))                        // Минифицируем JS если Production
        .pipe(rename(cfg.names.js))
        .pipe(gulp.dest(cfg.paths.build.js))
});
/* ================================================================================================================== */
